...
module.exports = {
  options: {
    bins: { mdhhinc, mdfaminc, mdnfinc },
    designFactor: 1.5,
    transform: { type: 'inflate' },
  },
  variables: [
    { name: 'mdhhinc', type: 'median' },
    {
      name: 'mnhhinc',
      type: 'mean',
      args: { universe: 'hh2', aggSum: 'aghhinc' },
    },
    { name: 'mdfaminc', type: 'median' },
    { name: 'mdnfinc', type: 'median' },
    {
      name: 'percapinc',
      type: 'mean',
      args: {universe: 'pop_6', aggSum: 'agip15pl'},
    },
  ],
};
