    ...
    chai.request(server)
      ...
      .end((err, res) => {
        ...
        const rowObject = res.body
          .find(obj => obj.variable === 'mdfaminc' && obj.dataset === 'y2012_2016');
  ...
  it('data with 0-estimate current should get pct change calculations: lgfrlep1 change_percentage_point should be calculated', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        ...
        const rowObject = res.body.find(obj => obj.variable === 'lgfrlep1' && obj.dataset === 'y2012_2016');
  ...
  it('data with 0-estimate previous should get pct change calculations: lgthalep1 change_percentage_point should be calculated', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        ...
        const rowObject = res.body.find(obj => obj.variable === 'lgthalep1' && obj.dataset === 'y2012_2016');
        expect(!!rowObject.change_percentage_point).to.equal(true);
        done();
      });
  });
  ...
  it('data with at least one non-null percentage point should be calculated: lgmkhm1 difference_percentage should be calculated', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        ...
        const rowObject = res.body.find(obj => obj.variable === 'lgmkhm1' && obj.dataset === 'y2012_2016');
...
it('data with both 0 estimates should be percentage point null: oscasia difference_percentage should be calculated', (done) => {
  chai.request(server)
    ...
    .end((err, res) => {
      ...
      const rowObject = res.body.find(obj => obj.variable === 'oscasia' && obj.dataset === 'y2012_2016');
...
it('pop30t34 change pct pt significance should be coded a true', (done) => {
  chai.request(server)
    ...
    .end((err, res) => {
      ...
      const rowObject = res.body.find(obj => obj.variable === 'pop30t34' && obj.dataset === 'y2012_2016');
...
it('cw_crpld Change percent MOE should only be null if previous estimate is 0', (done) => {
  chai.request(server)
    ...
    .end((err, res) => {
      ...
      const rowObject = res.body.find(obj => obj.variable === 'cw_crpld' && obj.dataset === 'y2012_2016');
...
it('sthrnafr single geog: percentage point difference not all always graying', (done) => {
  chai.request(server)
    ...
    .end((err, res) => {
      ...
      const rowObject = res.body.find(obj => obj.variable === 'sthrnafr' && obj.dataset === 'y2012_2016');
